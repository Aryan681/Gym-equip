...
const Home = ({ homeRef, featuresRef }) => {
  ...
  useEffect(() => {
    ...
    const firstLine = `Gym Equipment <br /><span class='bg-gradient-to-r from-blue-500 via-purple-600 to-indigo-700 bg-clip-text text-transparent'>AI Assistant</span>`;
    const secondLine = `Your Ultimate <br /><span class='bg-gradient-to-r from-blue-500 via-purple-600 to-indigo-700 bg-clip-text text-transparent'>AI Gym Partner</span>`;
    ...
    timeline.to({}, { duration: 0.5 }); // pause ~500ms
  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-gray-50 to-white overflow-hidden">
      ...
      <header
        id="hero-section"
        ref={homeRef}
        className="relative z-10 flex flex-col-reverse md:flex-row items-center justify-between px-6 py-16 max-w-6xl mx-auto my-4"
      >
        <div className="w-full md:w-1/2 mt-8 md:mt-0 text-center md:text-left">
          ...
          >
            Intelligent workout recommendations powered by computer vision.
            Generate personalized exercise suggestions in seconds.
          </p>
      ...
      {data && (
        <section
          ref={resultsRef}
          className="max-w-6xl mx-auto px-6 mb-20 space-y-12"
        >
      ...
      <section
        id="features-section"
        ref={featuresRef}
        className="py-20 px-6 bg-gradient-to-br from-white to-indigo-50"
      >
